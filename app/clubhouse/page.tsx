    ...
    <div className="min-h-screen bg-gray-900 flex flex-col">
      ...
      <div className="max-w-6xl mx-auto p-6 -mt-4 flex-1">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <Link href="/clubhouse/squad-stats" className="bg-gray-800 rounded-lg p-6 text-center hover:bg-gray-700 transition border-2 border-transparent hover:border-cyan-500">
            <div className="text-4xl mb-2">📈</div>
            <p className="text-white font-bold">Squad Stats</p>
            <p className="text-gray-500 text-sm">Season stats</p>
          </Link>
          ...
          <Link href="/clubhouse/medical" className="bg-gray-800 rounded-lg p-6 text-center hover:bg-gray-700 transition border-2 border-transparent hover:border-red-500">
            <div className="text-4xl mb-2">🏥</div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <Link href="/team-of-the-week" className="bg-gray-800 rounded-lg p-6 text-center hover:bg-gray-700 transition border-2 border-transparent hover:border-yellow-500">
            <div className="text-4xl mb-2">🏆</div>
            <p className="text-white font-bold">Team of the Week</p>
            <p className="text-gray-500 text-sm">Best performers</p>
          </Link>
        </div>
